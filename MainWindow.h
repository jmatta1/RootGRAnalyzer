...
void MainWindow::getFirstOrdShapes()
{
	...
	for(int i=0; i<numRuns; ++i)
	{
		...
		drawCmd<<"Thscat:Xfp>>"<<histName<<"(600,-600,600,300,-3,3)";
...
void MainWindow::makeBGSubSpecs()
{
	...
	for(int i=0; i<numRuns; ++i)
	{
		...
		TH2F* shapeHist = new TH2F(shapeHistName.c_str(), shapeHistTitle.c_str(), 600, -600, 600, 300, -3, 3);
		TH2F* trHist = new TH2F(trHistName.c_str(), trHistTitle.c_str(), 600, -600, 600, 300, -3, 3);
		TH2F* bgHist = new TH2F(bgHistName.c_str(), bgHistTitle.c_str(), 600, -600, 600, 300, -3, 3);
		TH2F* scaledBGHist = new TH2F(scaledBgHistName.c_str(), scaledBGHistTitle.c_str(), 600, -600, 600, 300, -3, 3);
		TH2F* subHist = new TH2F(subHistName.c_str(), subHistTitle.c_str(), 600, -600, 600, 300, -3, 3);
